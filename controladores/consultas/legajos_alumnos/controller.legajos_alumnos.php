<?php 
 ...
 if (strpos($_SERVER["PHP_SELF"] , $seccion_trabajo) >1 ) {
  ...
  include ($absolute_include."modelos/legajos_alumnos/model.legajos_alumnos.php");
  ...
  function archivos_index(){
    ...
    $resultado_carreras = buscar_legajos_alumnos();
       
    // llama a la vista de index de archivos

    include ($absolute_include."vistas/consultas/legajos_alumnos/legajos_alumnos.php"); 
