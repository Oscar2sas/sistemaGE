<?php 
 ...
 if (strpos($_SERVER["PHP_SELF"] , $seccion_trabajo) >1 ) {
  ...
  include ($absolute_include."modelos/legajos_personal/model.legajos_personal.php");
  ...
  function archivos_index(){
    ...
    $resultado_carreras = buscar_legajos_personal();
       
    // llama a la vista de index de archivos

    include ($absolute_include."vistas/consultas/legajos_personal/legajos_personal.php"); 
