...
<div class="title_right col-lg-4 col-md-4 col-sm-4 col-xs-4">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/telefonos/controller.telefonos.php" method="POST">
        <input type="hidden" name="accion" value="crear">  
        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  
        <button type="submit" class="btn btn-round btn-success btn-block"><i class="fa fa-plus"></i> Agregar telefono</button>
    </form>    
</div>
<div class="clearfix"><br></div>
<!-- text para busqueda -->
<div class="title_right col-lg-8 col-md-8 col-sm-8 col-xs-8">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/telefonos/controller.telefonos.php" method="GET">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table id="tabla" class="table table-stripped table-bordered nowrap cellspacing="0" width="100%">
                    ...
                    <?php foreach ($telefonos as $telefono): ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $telefono['cnumero_telefono']; ?></td>
                            <td class="text-center"><?php
                                if($telefono['ntipo_telefono'] == 1){
                                    echo "Telefono Celular";
                                }elseif($telefono['ntipo_telefono'] == 2){
                                    echo "Telefono Fijo";
                                }else{
                                    echo "Otro";
                                }
                    ...
                    ?></td>
                            <td class="text-center"><?php echo $telefono['cnombres_persona']; ?></td>
                ...
                <form action="<?php echo $carpeta_trabajo;?>/controladores/telefonos/controller.telefonos.php" method="POST">
                    ...
                    <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  
                    <button type="submit" class="btn btn-warning"><i class="fa fa-print"></i> Imprimir telefono</button>
                 </form>       
                 </div>
            </div>
        </div>
