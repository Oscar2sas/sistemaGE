            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/personas/controller.personas.php" method="POST" autocomplete="off">
                ...
                <h4>Telefonos</h4>
                    <div>
                        ...
                        <input type="text" class="form-control"  name="cnumero_telefono" placeholder="Ingrese el Número de Teléfono..." oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "10" required>
