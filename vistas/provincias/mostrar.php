        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/provincias/controller.provincias.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="nombre">Nombre la Provincia</label>
                    <input type="text" class="form-control"  name="cnombre_provincia" value="<?php echo $provincia['cnombre_provincia']; ?>" readonly>
