    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/documentospersonas/controller.documentospersonas.php ?>;" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                <input hidden type="text" name="documento_id" value="<?php echo $documento['documento_id']; ?>" readonly>
                ...
                <div class="form-group">
                    ...
                    <input hidden type="file" id="perfil" class="form-control" name="cimg_documento" accept="image/png, .jpeg, .jpg, .png, .pdf, .docx, .xml, .xlsx" required>
                </div>
