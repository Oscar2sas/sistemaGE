        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/log/controller.log.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <textarea  class="form-control"  name="cdescripcion_log" placeholder="Ingrese la descripcion..." required cols="30" rows="3" ><?php echo trim($log['cdescripcion_log']); ?></textarea>
                </div>
