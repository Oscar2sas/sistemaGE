...
<div class="title_right col-lg-4 col-md-4 col-sm-4 col-xs-4">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/roles/controller.roles.php" method="POST">
        <input type="hidden" name="accion" value="crear">
        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  
        <button type="submit" class="btn btn-round btn-success btn-block"><i class="fa fa-plus"></i> Agregar rol</button>
    </form>    
</div>
...
<div class="title_right col-lg-8 col-md-8 col-sm-8 col-xs-8">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/roles/controller.roles.php" method="GET">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table id="tabla" class="table table-stripped table-bordered nowrap cellspacing="0" width="100%">
                    ...
                    <?php foreach ($roles as $rol): ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $rol['cdescripcion_rol']; ?></td>
                ...
                <form action="<?php echo $carpeta_trabajo;?>/controladores/roles/controller.roles.php" method="POST">
                    ...
                    <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  
                    <button type="submit" class="btn btn-warning"><i class="fa fa-print"></i> Imprimir roles</button>
                 </form>       
                 </div>
            </div>
        </div>
