...
<div class="title_right col-lg-4 col-md-4 col-sm-4 col-xs-4">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/parametros/controller.parametros.php" method="POST">
        <input type="hidden" name="accion" value="crear">  
        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  
        <button type="submit" class="btn btn-round btn-success btn-block"><i class="fa fa-plus"></i> Agregar Un Parametro</button>
    </form>    
</div>
...
<div class="title_right col-lg-8 col-md-8 col-sm-8 col-xs-8">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/parametros/controller.parametros.php" method="GET">
                ...
                <table id="tabla" class="table table-stripped table-bordered nowrap cellspacing="0" width="100%">
                    ...
                    <?php foreach ($parametros as $parametro): ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $parametro['descripcion']; ?></td>
                            <td class="text-center"><?php echo $parametro['valor']; ?></td>
                            <td class="text-center"><?php echo $parametro['tipo']; ?></td>
