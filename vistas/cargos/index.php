...
<div class="title_right col-lg-4 col-md-4 col-sm-4 col-xs-4">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/cargos/controller.cargos.php" method="POST">
        <input type="hidden" name="accion" value="crear">  
        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  
        <button type="submit" class="btn btn-round btn-success btn-block"><i class="fa fa-plus"></i> Agregar Cargo</button>
    </form>    
</div>
<div class="clearfix"><br></div>
<!-- text para busqueda -->
<div class="title_right col-lg-8 col-md-8 col-sm-8 col-xs-8">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/cargos/controller.cargos.php" method="GET">
                ...
                <table id="tabla" class="table table-resposive table-stripped table-bordered nowrap " cellspacing="0" width="100%">
                    ...
                    <?php foreach ($cargos as $cargo): ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $cargo['cdescripcion_cargo']; ?></td>
                    ...
                    <tr>
                        <td width="90%">       
                            <form action="<?php echo $carpeta_trabajo;?>/controladores/cargos/controller.cargos.php" method="POST">
                                    ...
                                    <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  
                                    <button type="submit" class="btn btn-warning"><i class="fa fa-print"></i> Imprimir Cargos</button>
                                </form>       
                        </td>                 
                        <td>       
