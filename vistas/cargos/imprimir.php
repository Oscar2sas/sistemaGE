...
<body>
    ...
    <h3 align="center"> Lista de Cargos </h3> 
    ...
    <table  class="table table-stripped table-bordered nowrap " cellspacing="0" width="100%">
       ...
       <tr>
            <td bgcolor="silver">Descripci&oacute;n del Cargo</td>
       </tr>
    ...
    <div id="botones">    
        <form action="<?php echo $carpeta_trabajo;?>/controladores/cargos/controller.cargos.php" target="_blank" method="POST">
            <input type="hidden" name="accion" value="pdf">  
            <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  

            <button type="button" class="btn btn-info" onClick = "window.location.href = '<?php echo $carpeta_trabajo;?>/controladores/cargos/controller.cargos.php';" > Volver</button>
