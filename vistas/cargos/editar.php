        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/cargos/controller.cargos.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="nombre">Descripci&oacute;n del Cargo</label>
                    <input type="text" class="form-control"  name="cdescripcion_cargo" placeholder="Ingrese la Descripci&oacute;n..." value="<?php echo $cargo['cdescripcion_cargo']; ?>" required >
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-7">
