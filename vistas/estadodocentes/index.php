...
<div class="title_left col-lg-8 col-md-8 col-sm-8 col-xs-8">
        <h4>Estado de Docentes</h4>
</div>

<!-- boton  para agregar -->
<div class="title_right col-lg-4 col-md-4 col-sm-4 col-xs-4">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/estadodocentes/controller.estadodocentes.php" method="POST">
...
<div class="title_right col-lg-8 col-md-8 col-sm-8 col-xs-8">
    <form action="<?php echo $carpeta_trabajo;?>/controladores/estadodocentes/controller.estadodocentes.php" method="GET">
                ...
                <table id="tabla" class="table table-resposive table-stripped table-bordered nowrap " cellspacing="0" width="100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Estado de Docente</th>
                    ...
                    <?php if (count($estadodocentes)>10 ) {
                        echo "<tfoot>";       
                        echo "<tr>";
                        echo "<th class='text-center'>Estado de Docente</th>";
