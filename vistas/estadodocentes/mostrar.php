        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/estadodocentes/controller.estadodocentes.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="cdescripcion_estadodocente">Descripci&oacute;n del Estado</label>
                    <input type="text" class="form-control"  name="cdescripcion_estadodocente" value="<?php echo $estadodocente['cdescripcion_estadodocente']; ?>" readonly>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-9">
