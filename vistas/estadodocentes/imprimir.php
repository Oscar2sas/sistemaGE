...
<body>
    ...
    <h3 align="center"> Lista de Estados de Docentes </h3> 
    ...
    <table  class="table table-stripped table-bordered nowrap " cellspacing="0" width="100%">
       ...
       <tr>
            <td bgcolor="silver">Descripci&oacute;n del Estado</td>
       </tr>
   
        <?php foreach ($estadodocentes as $estadodocente): ?>
        <tr>
            
            <td class="text-center"><?php echo $estadodocente['cdescripcion_estadodocente']; ?></td>
    ...
    <div id="botones">    
        <form action="<?php echo $carpeta_trabajo;?>/controladores/estadodocentes/controller.estadodocentes.php" target="_blank" method="POST">
            <input type="hidden" name="accion" value="pdf">  
            <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  

            <button type="button" class="btn btn-info" onClick = "window.location.href = '<?php echo $carpeta_trabajo;?>/controladores/estadodocentes/controller.estadodocentes.php';" > Volver</button>
