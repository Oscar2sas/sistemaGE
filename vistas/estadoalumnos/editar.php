        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/estadoalumnos/controller.estadoalumnos.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="cdescripcion_estadoalumno" placeholder="Ingrese la Descripci&oacute;n..." value="<?php echo $estadoalumno['cdescripcion_estadoalumno']; ?>" required >
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-7">
