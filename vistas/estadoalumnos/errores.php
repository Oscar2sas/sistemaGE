    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/estadoalumnos/controller.estadoalumnos.php" method="POST" autocomplete="off">
                 ...
                 <input type="hidden" name="accion" value="<?php if($validacion_errores['estadoalumno_id']<>0) {echo "editar";} else {echo "crear";} ?>">  
                 
                 <input type="hidden"  name="estadoalumno_id" value="<?php echo $validacion_errores['estadoalumno_id']; ?>">
