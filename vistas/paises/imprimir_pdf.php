...
<body >
    <table width="100%">
        <tr>
         ...
         <h3 aling="center"> Lista de Paises </h3> 
    <hr>
    ...
    <thead>
        <tr>
            <th colspan="1">Abreviacion del Pais</th>
            <th colspan="1">Nombre del Pais</th>
            <th colspan="1">Bandera del Pais</th>
        </tr>
    </thead>
    ...
    <?php foreach ($paises as $pais): ?>
        <tr>
            <td calss="text-center"><?php echo $pais['cacortacion_pais']; ?></td>
            <td class="text-center"><?php echo $pais['cnombre_pais']; ?></td>
            <td calss="text-center"><?php echo $pais['cbandera']; ?></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
    </table>
