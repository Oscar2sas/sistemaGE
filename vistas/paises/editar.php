        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/paises/controller.paises.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="cacortacion_pais" id="cacortacion_pais" placeholder="Ejemplos ARG, CHL, PAR...">
                <br>
                ...
                <br>
                    ...
                    <input type='file' class="form-control" name="cbandera" id="cbandera" placeholder="Ingrese una imagen...">
                </div>
