        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <form action="<?php echo $carpeta_trabajo;?>/controladores/etapasescolares/controller.etapasescolares.php" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="cdescripcion_etapa" placeholder="Ingrese la Actualizacion..." value="<?php echo $etapas['cdescripcion_etapa']; ?>" required >
                </div>
                <div class="form-group">    
                    <div class="row">
                        <div class="col-6">
