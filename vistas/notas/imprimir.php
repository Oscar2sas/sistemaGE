...
<body>
    <table width="100%">
       ...
       <h3  align="center"> Lista de Provincias </h3> 
       <hr>
    ...
    <table  class="table table-stripped table-bordered nowrap " cellspacing="0" width="100%">
        ...
        <tr bgcolor="silver">
            ...
            <td class="text-center">Nombre de la Provincia</th>
            <td class="text-center">Pais</th>
    ...
    <br>           
    <div id="botones">    
        <form action="<?php echo $carpeta_trabajo;?>/controladores/provincias/controller.provincias.php" target="_blank" method="POST">
            <input type="hidden" name="accion" value="pdf">  
            <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">  

            <button type="button" class="btn btn-info" onClick = "window.location.href = '<?php echo $carpeta_trabajo;?>/controladores/provincias/controller.provincias.php';" > Volver</button>
